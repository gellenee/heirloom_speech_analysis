...
opensmile_config = "/Users/glenned.delatorre/tools/opensmile-3.0.2-macos-x86_64/config/egemaps/v01a/eGeMAPSv01a.conf"
...
for i, row in df.iterrows():
    ...
    subprocess.run([
        "/Users/glenned.delatorre/tools/opensmile-3.0.2-macos-x86_64/bin/SMILExtract",
        "-C", opensmile_config,
        "-I", wav_path,
        "-start", str(start),
        "-end", str(end),
